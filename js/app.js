(() => {
    ...
    function initSliders() {
        if (document.querySelector(".mainblock__slider")) new swiper_core_Swiper(".mainblock__slider", {
            ...
            pagination: {
                el: ".control-mainblock__dots",
                clickable: true
            },
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".fraction-control__all");
                    const allSlidesItems = document.querySelectorAll(".slide-mainblock:not(.swiper-slide-duplicate)");
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest(".menu-top-head__link_catalog")) {
